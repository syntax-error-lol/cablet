...
const TwemojiCompat = Twemoji as unknown as ComponentType<{ options?: { className?: string }; children?: ReactNode }>;
        ...
        <span className={styles.messageHolder} style={{
            ...
            >
                {message.replyingTo && replyingToAuthor && <div className={styles.replyingTo} onClick={() => {
                    ...
                    <TwemojiCompat options={{ className: `${styles.emoji} ${styles.emojiReply}` }}>
                    ...
                    >
                        ...
                        <div style={{
                            ...
                            {!isEditing
                                ...
                                ? <TwemojiCompat options={{ className: styles.emoji }}><MarkdownEditor key={contentKey} content={message.content.replaceAll(/\n/g, "\n\n")} color={message.color || undefined} readOnly={true} /></TwemojiCompat>
                                : <>
                                    <MarkdownEditor
                                        key={contentKey}
