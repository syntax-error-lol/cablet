...
const VirtualizedAutoSizer: any = AutoSizer;
const VirtualizedCollection: any = Collection;
const VirtualizedList: any = List;
...
export default function ItemContainer({ user, options, onClick, ...props }: ItemContainerProps) {
    ...
    // flat grid
    const renderFlatCollection = () => <VirtualizedAutoSizer>
                ...
                <div key={key} style={style} className={styles.setContainer}>
                    ...
                    <div className={styles.setContent} style={{ height: totalH }}>
                        <VirtualizedCollection
                            ...
                            cellRenderer={({ index, key: ckey, style: cstyle }: any) => {
                                const p = pos[index];
    ...
    const renderPacksList = () => <VirtualizedAutoSizer>
        {({ width, height }: { width: number; height: number }) => {
            ...
            return (
                <VirtualizedList
                    ...
                    rowHeight={({ index }: any) => rowHeights[index] || PACK_HEADER_H}
