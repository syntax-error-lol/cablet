...
function formatPaymentMethodLabel(method: UserPaymentMethod) {
    const type = method.type === "CARD" ? "Card" : method.type === "CASHAPP" ? "Cash App" : method.type === "PAYPAL" ? "PayPal" : "Payment";
    ...
    return (
        <>
            ...
            <Modal.ModalBody>
                ...
                <Dropdown
                    options={[
                        ...user.paymentMethods.map((method) => ({
                            label: formatPaymentMethodLabel(method), value: method.id
                        })),
                ...
                >
                    {selectedPaymentMethod ? formatPaymentMethodLabel(selectedPaymentMethod) : "Select a payment method..."}
                </Dropdown>
            </Modal.ModalBody>
